  ...
  if (targetLectureCode) {
    ...
    if (lecture) {
      ...
      detailHeader.insertAdjacentHTML(
        'beforeend',
        `<div id="detail-title">${lecture.titleJp}</div>`
      );
...
<section>
  <header>教員</header>
  <div>${lecture.lecturerJp}</div>
</section>
<section>
  <header>種別</header>
  <div>${lecture.type + "科目 " + lecture.category}</div>
</section>
<section>
  <header>開講学期</header>
  <div>${lecture.semester}</div>
</section>
<section>
  <header>対象クラス</header>
...
<section>
  <header>曜限</header>
  <div>${lecture.periods}</div>
</section>
<section>
  <header>詳細</header>
  <div>${lecture.detail}</div>
</section>
<section>
  <header>講義計画</header>
  <div>${lecture.schedule}</div>
</section>
<section>
  <header>講義方法</header>
  <div>${lecture.methods}</div>
</section>
<section>
  <header>評価</header>
  <div>${lecture.evaluation}</div>
</section>
<section>
  <header>注意</header>
